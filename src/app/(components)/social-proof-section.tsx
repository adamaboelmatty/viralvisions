...
export function SocialProofSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      description: `ViralVisions didn't just help me grow my following; they taught me how to monetize effectively. Their personalized approach and expert guidance helped me navigate the complexities of TikTok's algorithm and audience engagement. Even with a modest following of 5,000, I was able to achieve remarkable results. ViralVisions truly empowers creators to turn their passion into a profitable venture.`,
      stats: [
        { value: "$8,000+", label: "First Month" },
        { value: "$75/hour", label: "Average Earnings" },
        { value: "5,000", label: "Followers" },
      ],
    },
  ];
